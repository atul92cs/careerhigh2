                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group ">
                            ...
                            <input class="form-control lead-0" type="text" name="metahtml" placeholder="Metahtml">
                        </div>
                        <div class="form-group ">
                            <label>Image</label>
            ...
            <form id="update" method="post" enctype="multipart/form-data" action="#">
                ...
                <div class="card">
                    <div class="card-body" >
                        ...
                        <div class="form-group ">
                            <label>Url</label>
                            <input class="form-control lead-0" type="text" name="url"  id="url" placeholder="Url">
                        </div>
                        <div class="form-group ">
                            <label>Metahtml</label>
                            <input class="form-control lead-0" type="text" name="metahtml" id="metahtml" placeholder="Metahtml">
                        </div>
                        <div class="form-group ">
                            <label>Image</label>
                            <input class="form-control lead-0" type="file" name="cover_image" id="cover_image" placeholder="cover_image">
                        </div>
                        <div class="form-group">
                            <label>Status</label>
                            <div class="switch d-inline m-r-10">
                                ...
                                <div class="card-body table-full-width">
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            ...
                                            <th data-field="shifting"  data-sortable="true">Shift Categories</th>
                                            ...
                                            <tr>
                                               <td>{{++$i}}</td>
                                                ...
                                                <td>
                                                    @if($i!=1)
                                                    <button type="button"
                                                            data-fromchange="{{$m->id}}"
                                                            data-tochange="{{$old}}"
                                                            data-type="up"
                                                            class="btn btn-icon btn-rounded btn-outline-primary shift11" rel="tooltip" title="Shift up"><i class="feather icon-arrow-up"></i></button>
                                                   @endif
                                                    @if(isset($main[$i]->id))
                                                <button type="button" 
                                                        data-fromchange="{{$m->id}}"
                                                        data-tochange="{{$main[$i]->id}}"
                                                        data-type="up"
                                                        class="btn btn-icon btn-rounded btn-outline-success shift11" rel="tooltip" title="Shift down"><i class="feather icon-arrow-down"></i></button>
                                                    @endif
...
<script>
 ...
 $("#bootstrap-table").delegate('.shift11','click',function() { 
//     alert(1);
        var formData = new FormData();
     formData.append('fromchange',$(this).data('fromchange'));
     formData.append('tochange',$(this).data('tochange'));
