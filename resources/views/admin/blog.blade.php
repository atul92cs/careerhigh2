                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="card bootstrap-table">
                                <div class="card-body table-full-width">
                                    <div class="toolbar">
                                        <a class="btn btn-theme" data-toggle="modal" href="{{route('blog.create')}}">Add {{$page_title}}</a>
                                    ...
                                    <table id="bootstrap-table" class="table">
                                        <thead>
                                            ...
                                            <th data-field="author" class="text-left"  data-visible="true">Author</th>
...
//                $('#id').val(row.id);
                ...
                window.location="{{url('admin/blog')}}/"+row.id+"/edit";
