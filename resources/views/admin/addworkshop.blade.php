                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <input class="form-control lead-0" type="text" name="location" placeholder="location">
                                            </div>
                                            <div class="form-group ">
                                                <label>Duration</label>
                                                <input class="form-control lead-0" type="text" name="duration" placeholder="duration">
                                            </div>
                                            <div class="form-group ">
                                                <label>Date From</label>
                                                <input class="form-control" id="date" type="text" name="date1" placeholder="datetime">
                                            </div>
                                            <div class="form-group ">
                                                <label>Date To</label>
                                                <input class="form-control" id="date2" type="text" name="date2" placeholder="datetime">
                                            </div> 
                                            <div class="form-group ">
                                                <label>Time From</label>
                                                <input class="form-control" id="time" type="text" name="time1" placeholder="datetime">
                                            </div>
                                            <div class="form-group ">
                                                <label>Time To</label>
                                                <input class="form-control" id="time2" type="text" name="time2" placeholder="datetime">
                                            </div>
                                            <div class="form-group ">
                                                <label>Price</label>
                                                <input class="form-control lead-0" type="text" name="price" placeholder="price">
                                            </div>
                                            <div class="form-group ">
                                                <label>Booking Limit</label>
                                                <input class="form-control lead-0" type="text" name="subs_limit" placeholder="subs_limit">
                                            </div>
                                            <div class="form-group ">
                                                <label>Domain Blocking</label>
                                                <input class="form-control lead-0" type="text" name="domain" placeholder="domain">
                                            </div>
                                            <div class="form-group ">
                                                <label>College Name</label>
                                                <input class="form-control lead-0" type="text" name="college" placeholder="college">
                                            </div>
