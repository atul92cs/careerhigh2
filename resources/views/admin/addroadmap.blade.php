                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <input class="form-control lead-0" type="text" name="video"  placeholder="Enter Video url...">
                                            </div>
                                            <div class="form-group">
                                                <label>Status</label>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a class="btn btn-default" type="button"  aria-label="Close" href="{{route('roadmap.index')}}">Close</a>
                                        </div>
                                    </div>
                                </form>
